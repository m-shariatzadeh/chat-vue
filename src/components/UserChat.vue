      ...
      <div class="bg-white border-t p-4" v-if="chatExist">
        <div class="max-w-4xl mx-auto flex items-center space-x-4">
          ...
          <div v-if="editMode" class="flex">
            <button @click="updateMessage" class="p-1 text-white bg-green-600 rounded-full size-11 hover:bg-green-700 transition" :disabled="loading">
              <i class="fa-solid fa-check" v-if="!loading"></i>
